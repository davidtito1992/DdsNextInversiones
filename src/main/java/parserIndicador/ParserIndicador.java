...
FormulaIndicador expresion2 ;
 ...
 {if (true) return new Expresion(expresion1,new Constante("0"),new Suma());}
    throw new Error("Missing return statement in function");
  }
...
FormulaIndicador termino2;
    ...
    while (true) {
      ...
      case MULTIPLICACION:
        ...
        termino2 = fact();
                                                         termino1= new Expresion(termino1,termino2,new Multiplicacion());
        break;
      case DIVISION:
 ...
 {if (true) return new Expresion(termino1,new Constante("1"),new Multiplicacion());}
    throw new Error("Missing return statement in function");
  }
...
FormulaIndicador fact1 ;
  ...
  final public List<Variable> variables() throws ParseException {
   {if (true) return listaDeVariables;}
    throw new Error("Missing return statement in function");
  }
