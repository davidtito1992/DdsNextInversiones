...
public class IndicadorController {
	...
	public static ModelAndView home(Request req, Response res) {
		Map<String, Object> mapIndicadores = IndicadorService.homeView(TokenUtils.autenticar(req, res));
	...
	public static ModelAndView agregarView(Request req, Response res) {
		Map<String, Object> mapIndicadores = IndicadorService.homeAgregarIndicador(TokenUtils.autenticar(req, res),
	...
	public static Void agregar(Request req, Response res) {
		try {
			IndicadorService.agregar(req.queryParams("nombre"), req.queryParams("formula"),
					TokenUtils.autenticar(req, res));
			res.cookie("Notificacion", "Indicador: '" + req.queryParams("nombre") + "' creado exitosamente", 5);

		} catch (Exception e) {
			res.cookie("Notificacion", "No se pudo guardar el indicador: '" + e.getMessage() + "'", 5);
	...
	public static Void delete(Request req, Response res) {
		...
		res.cookie("Notificacion", "Indicador: '" + req.queryParams("indicadorId") + "' borrado exitosamente", 5);
