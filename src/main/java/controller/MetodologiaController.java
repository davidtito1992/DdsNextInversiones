...
public class MetodologiaController {
	...
	public static ModelAndView home(Request req, Response res) {
		Map<String, Object> mapMetodologias = MetodologiaService.homeView(TokenUtils.autenticar(req, res));
	...
	public static ModelAndView agregarCondicionesView(Request req, Response res) {
		...
		Map<String, Object> condiciones = MetodologiaService.mapeoCondiciones(TokenUtils.autenticar(req, res),
	...
	public static ModelAndView consultarView(Request req, Response res) {
		Map<String, Object> metodologias = MetodologiaService.consultarView(TokenUtils.autenticar(req, res),
	...
	public static Void agregarMetodologia(Request req, Response res) {
		...
		try {
			MetodologiaService.agregarMetodologia(TokenUtils.autenticar(req, res), req.params("nombreMetodologia"),
