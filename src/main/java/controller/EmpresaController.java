...
public class EmpresaController extends Controller {
	...
	public static ModelAndView home(Request req, Response res) {
		cuentaSeleccionada = Objects.isNull(req.queryParams("nombreCuenta"))
				|| req.queryParams("nombreCuenta").isEmpty() ? null : req.queryParams("nombreCuenta");
		nombreSeleccionado = Objects.isNull(req.queryParams("nombreEmpresa"))
				|| req.queryParams("nombreEmpresa").isEmpty() ? null : req.queryParams("nombreEmpresa");
		anioSeleccionado = Objects.isNull(req.queryParams("anio")) || req.queryParams("anio").isEmpty() ? null
	...
	public static HashMap<String, Object> armarHashMap(Long idUsuario) {
		...
		List<Empresa> empresasPorFiltros = idUsuario != null
				? repo.filtrar(cuentaSeleccionada, nombreSeleccionado, semestreSeleccionado, anioSeleccionado,
						idUsuario)
				: new ArrayList<>();

		mapEmpresas.put("empresas", repo.dameSnapshotEmpresas(empresasPorFiltros, nombreSeleccionado,
