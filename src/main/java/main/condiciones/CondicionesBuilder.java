...
public class CondicionesBuilder {
	...
	public Condicion crear(SnapshotCondicion snapshotCondicion) {
		...
		if (tipoCondicion.equals(TAXATIVA)) {
			...
			case MENOR:
				return new CondicionTaxativaMayorOMenorA(main.condiciones.CondicionSumatoria.MenorOMayor.menorA,
						registroIndicador, ultimosAnios, pesoOComparar);
			case MAYOR:
				return new CondicionTaxativaMayorOMenorA(main.condiciones.CondicionSumatoria.MenorOMayor.mayorA,
						registroIndicador, ultimosAnios, pesoOComparar);
			case ANTIGUEDAD:
			...
			switch (condicion) {
			case MENOR:
				return new CondicionCuantitativaMayorOMenorA(main.condiciones.CondicionSumatoria.MenorOMayor.menorA,
						registroIndicador, ultimosAnios, pesoOComparar);
			case MAYOR:
				return new CondicionCuantitativaMayorOMenorA(main.condiciones.CondicionSumatoria.MenorOMayor.mayorA,
						registroIndicador, ultimosAnios, pesoOComparar);
			case ANTIGUEDAD:
