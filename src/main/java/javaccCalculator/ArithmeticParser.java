...
public class ArithmeticParser implements ArithmeticParserConstants {
	...
	final public void calculation() throws ParseException {
		...
		System.out.println("Calculation: " + tOperandLeft.image + operator
				+ tOperandRight.image);
		expression = new Expression(new Value(tOperandLeft.image), new Value(
				tOperandRight.image), operator);
	}
